...
const Temperature = ({setCity, stats}) => {
  ...
  return (
   <>
   <div className='flex justify-between  text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out ' >
    <input
     type='text'
...
(<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-12 h-12 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out ">
